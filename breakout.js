...
Breakout = {
  ...
  Defaults: {
    ...
    ball: {
      ...
      speed:   15,
      labels: {
        3: { text: 'آماده ...', fill: '#D82800', stroke: 'black', font: 'bold 28pt arial' },
        2: { text: 'تنظیم ..',    fill: '#FC9838', stroke: 'black', font: 'bold 28pt arial' },
        1: { text: 'شروع!',      fill: '#80D010', stroke: 'black', font: 'bold 28pt arial' }
      }
    },
    ...
    keys: [
      ...
      { keys: [Game.KEY.RETURN, Game.KEY.RETURN], state: 'menu', action: function() { this.play();                     } },
      { keys: [Game.KEY.RETURN, Game.KEY.RETURN], state: 'game', action: function() { this.ball.launchNow();           } },
